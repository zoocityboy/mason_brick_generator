...
//   factory BrickYaml.fromJson(Map<dynamic, dynamic> json) => _$BrickYamlFromJson(json);
...
class BrickVariableProperties {
  ...
  /// Converts [Map] to [BrickYaml]
  factory BrickVariableProperties.fromJson(Map<dynamic, dynamic> json) => _$BrickVariablePropertiesFromJson(json);
  ...
  @override
  String toString() {
    return 'BrickVariableProperties(type: $type, description: $description, defaultValue: $defaultValue, defaultValues: $defaultValues, prompt: $prompt, values: $values, separator: $separator)';
  }
}
...
/// {@endtemplate}
class VarsConverter implements JsonConverter<Map<String, BrickVariableProperties>, dynamic> {
  ...
  Map<String, BrickVariableProperties> fromJson(dynamic value) {
    ...
    if (value0 is List) {
      return <String, BrickVariableProperties>{
        for (final v in value0) v as String: const BrickVariableProperties.string(),
      };
    }
    if (value0 is Map) {
      return value0.map(
        (dynamic key, dynamic value) => MapEntry(
          key as String,
          BrickVariableProperties.fromJson(value0[key] as Map),
        ),
      );
    }
...
class BrickEnvironment {
  ...
  /// Converts [Map] to [BrickYaml]
  factory BrickEnvironment.fromJson(Map<dynamic, dynamic> json) => _$BrickEnvironmentFromJson(json);
